...
/// background. Used for both the own-profile "EJ" avatar and every linked
/// client avatar on the "Profile & Settings" screen.
class FamilyInitialsAvatar extends StatelessWidget {
  final String initials;
  final Color background;
  final Color foreground;
  final double size;

  const FamilyInitialsAvatar({
    super.key,
