...
class VisitRequestsRepositoryImpl implements VisitRequestsRepository {
  ...
  // Matches the "My Requests - Visit Requests" screenshot card list and
  // status variety (Pending / Approved / Rejected / Reschedule / Cancelled).
  // Extra Pending/Approved rows keep the summary chips at 2 / 3 / 1.
  static const List<MyVisitRequest> _myRequests = [
    MyVisitRequest(
      ...
      notes:
          'Birthday celebration with the family — hoping to book the courtyard.',
    ),
    MyVisitRequest(
      id: 'my-2',
      type: VisitRequestType.visit,
    ...
    MyVisitRequest(
      ...
      status: VisitRequestStatus.rejected,
      locationModeLabel: 'Remote / Video Call',
      notes:
          'This time slot is unavailable. Please choose another appointment time.',
    ),
    MyVisitRequest(
      id: 'my-4',
      type: VisitRequestType.visit,
    ...
    MyVisitRequest(
      id: 'my-5',
      type: VisitRequestType.visit,
      dateTimeLabel: 'Apr 12, 2025 • 2:00 PM',
      status: VisitRequestStatus.cancelled,
      locationModeLabel: 'In-Person at Sunrise Home',
    ),
    MyVisitRequest(
    ...
    MyVisitRequest(
      id: 'my-7',
      type: VisitRequestType.appointment,
      dateTimeLabel: 'Mar 28, 2025 • 9:30 AM',
      status: VisitRequestStatus.approved,
      locationModeLabel: 'Remote / Video Call',
    ),
    MyVisitRequest(
      id: 'my-8',
      type: VisitRequestType.visit,
      dateTimeLabel: 'Mar 15, 2025 • 4:00 PM',
      status: VisitRequestStatus.pending,
      locationModeLabel: 'In-Person at Sunrise Home',
      notes: 'Afternoon catch-up visit after John’s therapy session.',
    ),
  ];
  ...
  static const Map<String, VisitRequestDetail> _details = {
    ...
    'my-4': VisitRequestDetail(
      ...
      roomLocationLabel: 'Sunrise Home · Room 207',
      purpose: 'Family Visit',
      notes: 'Requested a new time after the original slot conflicted.',
    ),
    'my-5': VisitRequestDetail(
      ...
      roomLocationLabel: 'Sunrise Home · Room 207',
      purpose: 'Family Visit',
      notes: 'Cancelled by family due to a schedule conflict.',
    ),
    ...
    'my-7': VisitRequestDetail(
      ...
      roomLocationLabel: 'Sunrise Home · Room 207',
      purpose: 'Care Plan Review',
      notes: 'Approved video check-in with the care team.',
    ),
    'my-8': VisitRequestDetail(
      id: 'my-8',
      type: VisitRequestType.visit,
      status: VisitRequestStatus.pending,
      dateTimeLabel: 'Mar 15, 2025 • 4:00 PM',
