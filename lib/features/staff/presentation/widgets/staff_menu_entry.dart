...
/// A single navigable entry shown on the Staff "MAR / Tasks" and "More" hub
/// pages — icon, title and subtitle. Shared so both hubs render identical
/// tiles.
class StaffMenuEntry {
  final IconData icon;
...
class StaffMenuTile extends StatelessWidget {
  final StaffMenuEntry entry;
  final VoidCallback onTap;

  const StaffMenuTile({super.key, required this.entry, required this.onTap});
