...
class StaffIncidentsTabBar extends StatelessWidget {
  ...
  /// Pale mint badge + deep teal count.
  static const _BadgeStyle _badgeStyle = _BadgeStyle(
    Color(0xFFD4F7E5),
    Color(0xFF005F56),
  );
  ...
  const StaffIncidentsTabBar({
    ...
    this.allIncidentsCount = 0,
    this.myIncidentsCount = 0,
  });
