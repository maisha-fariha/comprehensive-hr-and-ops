    ...
    return Result.success(
      const SchedulingOverview(
        calendar: CalendarSchedule(
          monthLabel: 'May 2025',
          days: [
            CalendarDay(dayLabel: 'Mon', dayNumber: '12'),
            CalendarDay(dayLabel: 'Tue', dayNumber: '13', isSelected: true),
            CalendarDay(dayLabel: 'Wed', dayNumber: '14'),
            CalendarDay(dayLabel: 'Thu', dayNumber: '15'),
            CalendarDay(dayLabel: 'Fri', dayNumber: '16'),
            CalendarDay(dayLabel: 'Sat', dayNumber: '17'),
            CalendarDay(dayLabel: 'Sun', dayNumber: '18'),
          ],
